...
void TechTree::initUnitTypeData()
{
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_REACTOR, m_bot)] =                  { sc2::Race::Terran, 0, 0, 0, 0, true, true, false, false, false, false, true, sc2::ABILITY_ID::BUILD_REACTOR, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_BARRACKS, m_bot) }, {}, {} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_GHOST, m_bot)] =                    { sc2::Race::Terran, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_GHOST, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_BARRACKS, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_BARRACKSTECHLAB, m_bot), UnitType(sc2::UNIT_TYPEID::TERRAN_GHOSTACADEMY, m_bot)}, {} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LURKERDENMP, m_bot)] = { sc2::Race::Zerg, 0, 0, 0, 0, true, true, false,  true, false, false, false, 1163, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_DRONE, m_bot) },{UnitType(sc2::UNIT_TYPEID::ZERG_HYDRALISKDEN, m_bot)},{} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_NYDUSCANAL, m_bot)] = { sc2::Race::Zerg, 0, 0, 0, 0, true, true, false, false, false, false, false, sc2::ABILITY_ID::BUILD_NYDUSWORM, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_NYDUSNETWORK, m_bot) }, {}, {} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_CREEPTUMOR, m_bot)] =                 { sc2::Race::Zerg, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_CREEPTUMOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_CREEPTUMORBURROWED, m_bot),UnitType(sc2::UNIT_TYPEID::ZERG_QUEEN, m_bot) },{},{} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_CREEPTUMORBURROWED, m_bot)] = { sc2::Race::Zerg, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_CREEPTUMOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_CREEPTUMORBURROWED, m_bot),UnitType(sc2::UNIT_TYPEID::ZERG_QUEEN, m_bot) },{},{} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_CREEPTUMORQUEEN, m_bot)] =			 { sc2::Race::Zerg, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_CREEPTUMOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_QUEEN, m_bot) },{},{} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_OVERSEER, m_bot)] = { sc2::Race::Zerg, 0, 0, 0, 0, true, false, false, false,  true, false, false, sc2::ABILITY_ID::MORPH_OVERSEER, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORD, m_bot) },{UnitType(sc2::UNIT_TYPEID::ZERG_LAIR, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_HIVE, m_bot)},{} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BANELING, m_bot)] = { sc2::Race::Zerg, 0, 0, 0, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_BANELING, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_ZERGLING, m_bot) }, { UnitType(sc2::UNIT_TYPEID::ZERG_BANELINGNEST, m_bot) }, {} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LURKERMP, m_bot)] = { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, 2332, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_HYDRALISK, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_LURKERDENMP, m_bot) },{} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot)] =                      { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, 0, 0, {}, {}, {} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_EGG, m_bot)] =                        { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, 0, 0, {}, {}, {} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BROODLORD, m_bot)] = { sc2::Race::Zerg, 0, 0, 1, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::MORPH_BROODLORD, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_CORRUPTOR, m_bot) }, { UnitType(sc2::UNIT_TYPEID::ZERG_GREATERSPIRE, m_bot) }, {} };
	...
	for (auto & kv : m_unitTypeData)
	{
		...
		kv.second.supplyCost = data.food_required;
	}
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_HIVE, m_bot)].gasCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_LAIR, m_bot)).gasCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LAIR, m_bot)].gasCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_HATCHERY, m_bot)).gasCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_GREATERSPIRE, m_bot)].gasCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_SPIRE, m_bot)).gasCost;

	// fix the cumulative prices of morphed units
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_OVERSEER, m_bot)].mineralCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORD, m_bot)).mineralCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_OVERSEER, m_bot)].gasCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORD, m_bot)).gasCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_OVERSEER, m_bot)].supplyCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORD, m_bot)).supplyCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BANELING, m_bot)].mineralCost = 25;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BANELING, m_bot)].gasCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_ZERGLING, m_bot)).gasCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BANELING, m_bot)].supplyCost = 0;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_RAVAGER, m_bot)].mineralCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_ROACH, m_bot)).mineralCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_RAVAGER, m_bot)].gasCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_ROACH, m_bot)).gasCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_RAVAGER, m_bot)].supplyCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_ROACH, m_bot)).supplyCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LURKERMP, m_bot)].mineralCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_HYDRALISK, m_bot)).mineralCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LURKERMP, m_bot)].gasCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_HYDRALISK, m_bot)).gasCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LURKERMP, m_bot)].supplyCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_HYDRALISK, m_bot)).supplyCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BROODLORD, m_bot)].mineralCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_CORRUPTOR, m_bot)).mineralCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BROODLORD, m_bot)].gasCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_CORRUPTOR, m_bot)).gasCost;
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BROODLORD, m_bot)].supplyCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_CORRUPTOR, m_bot)).supplyCost;
}
...
void TechTree::initUpgradeData()
{
    ...
    m_upgradeData[sc2::UPGRADE_ID::DRILLCLAWS] =                        { sc2::Race::Terran, 150, 150, 0, 1760, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_DRILLINGCLAWS, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_ARMORY, m_bot) }, {} };
    ...
    m_upgradeData[sc2::UPGRADE_ID::LIBERATORAGRANGEUPGRADE] =           { sc2::Race::Terran, 150, 150, 0, 1760, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_ADVANCEDBALLISTICS, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORTTECHLAB, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_FUSIONCORE, m_bot) }, {} };
    ...
    m_upgradeData[sc2::UPGRADE_ID::MEDIVACINCREASESPEEDBOOST] =         { sc2::Race::Terran, 100, 100, 0, 1280, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_HIGHCAPACITYFUELTANKS, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORTTECHLAB, m_bot) }, {}, {} };
    ...
    m_upgradeData[sc2::UPGRADE_ID::RAVENCORVIDREACTOR] =                { sc2::Race::Terran, 150, 150, 0, 1760, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_RAVENCORVIDREACTOR, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORTTECHLAB, m_bot) }, {}, {} };
	...
	m_upgradeData[sc2::UPGRADE_ID::RAPIDFIRELAUNCHERS] =                { sc2::Race::Terran, 250, 250, 0, 3520, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_RAPIDFIRELAUNCHERS, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot) }, {}, {} };
	m_upgradeData[sc2::UPGRADE_ID::SMARTSERVOS] =                       { sc2::Race::Terran, 250, 250, 0, 3520, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_SMARTSERVOS, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_ARMORY, m_bot) }, {} };
	...
	m_upgradeData[sc2::UPGRADE_ID::CENTRIFICALHOOKS] = { sc2::Race::Zerg, 150, 150, 0, 1760, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_CENTRIFUGALHOOKS, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_BANELINGNEST, m_bot) }, { UnitType(sc2::UNIT_TYPEID::ZERG_LAIR, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_HIVE, m_bot) }, {} };
	...
	for (auto & kv : m_upgradeData)
	{
		...
		auto & data = m_bot.Observation()->GetUpgradeData()[kv.first];

		kv.second.mineralCost = data.mineral_cost;
		kv.second.gasCost = data.vespene_cost;
		kv.second.buildTime = data.research_time;
	}
}
#else
void TechTree::initUpgradeData()
