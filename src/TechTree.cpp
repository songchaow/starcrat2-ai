...
void TechTree::initUnitTypeData()
{
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BANELING, m_bot)].mineralCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_ZERGLING, m_bot)).mineralCost;
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BANELING, m_bot)].supplyCost -= getData(UnitType(sc2::UNIT_TYPEID::ZERG_ZERGLING, m_bot)).supplyCost;
...
void TechTree::initUpgradeData()
{
    ...
    m_upgradeData[sc2::UPGRADE_ID::BATTLECRUISERENABLESPECIALIZATIONS]= { sc2::Race::Terran, 150, 150, 0,  960, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_BATTLECRUISERWEAPONREFIT, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORTTECHLAB, m_bot) }, {}, {} };
