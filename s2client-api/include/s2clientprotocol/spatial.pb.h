...
class FeatureLayers : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SC2APIProtocol.FeatureLayers) */ {
 ...
 private:
  ...
  inline void set_has_unit_energy_ratio();
  inline void clear_has_unit_energy_ratio();
  inline void set_has_unit_shields();
  inline void clear_has_unit_shields();
  inline void set_has_unit_shields_ratio();
  inline void clear_has_unit_shields_ratio();
...
inline void FeatureLayers::clear_unit_energy_ratio() {
...
inline void FeatureLayers::clear_unit_shields_ratio() {
...
inline void FeatureLayers::clear_effects() {
